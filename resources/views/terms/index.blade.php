...
@section('content')
    <h2>{{ $domain }} Terms of Use</h2>

    <h3>Overview</h3>
    <p>
        Throughout the site, the terms "we", "us" and "our" refer to {{ $siteName }}.
        {{ $siteName }} offers this website, including all information, tools and
    ...
    <p>
        ...
        version of the Terms of Use at any time on this page. We reserve the right
        to update, change or replace any part of these Terms of Use by posting
        ...
        the website following the posting of any changes constitutes acceptance
        of those changes.
    </p>
    ...
    <p>
        ...
        basis for making decisions without consulting primary, more accurate,
    ...
    <p>
        ...
        any time without notice, at the sole discretion of us. We reserve the right
    ...
    <p>
        ...
        or responsibility for any third-party materials or websites, or for any
    ...
    <p>
        ...
        by postal mail, or otherwise (collectively, "comments"), you agree that we may,
        at any time, without restriction, edit, copy, publish, distribute, translate
    ...
    <p>
        ...
        for any comments you makeand their accuracy. We take no responsibility and
    ...
    <p>
        ...
        <a href="/privacy">{{ trans('LaravelTreats::site.link.privacy') }}</a>.
    </p>
    ...
    <p>
        In addition to other prohibitions as set forth in the Terms of Use, you
    ...
    <p>
        ...
        all implied warranties or conditions of merchantability, merchantable quality,
    ...
    <p>
        ...
        be liable for any injury, loss, claim, or any direct, indirect, incidental,
        ...
        costs, or any similar damages, whether based in contract, tort (including negligence),
        ...
        in any way to your use of the Service or any product, including, but not limited to,
    ...
    <p>
        ...
        comply with any term or provision of these Terms of Use, we also may terminate
    ...
    <p>
        ...
        of Parma, OH, United States 44134.
    </p>
    ...
    <p>
        ...
        any part of these Terms of Use by posting updates and changes to our website.
        ...
        the posting of any changes to these Terms of Use constitutes acceptance
        of those changes.
    </p>

    <h3>Section 20 - Contact Information</h3>
    <p>
        Questions about the Terms of Use should be emailed to us at
        support [at] {{ $domain }}.
    </p>
@endsection
